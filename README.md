...
[latency-topology-visualizer.netlify.app](https://latency-topolozy-visualizer.netlify.app/)

The live app renders a real-time latency globe with layers for exchanges and cloud regions, providers (AWS, GCP, Azure, Private), latency filters, and node-level statistics as seen on the deployed site [`https://latency-topolozy-visualizer.netlify.app/`](https://latency-topolozy-visualizer.netlify.app/).
...
- **1. Clone the repository**
  ...
  npm run dev
    Then open `http://localhost:3000` in your browser (with WebGL enabled) to view the latency topology visualizer, which should behave like the live app at [`https://latency-topolozy-visualizer.netlify.app/`](https://latency-topolozy-visualizer.netlify.app/).
...
- **Architecture**
  - **App Router**: The project uses the Next.js App Router under `app`.
